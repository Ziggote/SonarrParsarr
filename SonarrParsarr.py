...
# # API key & endpoint
# api_key = "2d763e4c7e294686a5d7e553518b1260"
...
#         writer.writerow(["Title", "Download ID", "ID", "Sizeleft", "Size", "Status"])
#         for torrent in data:
...
#             print("\n")
#             # print(data)
#             writer.writerow([title, download_id, id, sizeleft, size, status])
# else:
#     print("Request failed with status code", response.status_code)

######################################################################################
#                        ^   ^   ^   ^   ^   ^   ^   ^
# ****************   ORIGINAL WORKING CODE, DO NOT ALTER   *********************
#                        ^   ^   ^   ^   ^   ^   ^   ^
######################################################################################
...
#                 for row in reader:
#                     # Read the existing strikes from the file
...
#                     # Increment the strike count if the status is 'Warning'
#                     if status == "Warning":
#                         strikes[download_id] = strikes.get(download_id, 0) + 1
#                     elif status == "Downloading" and strikes.get(download_id, 0) > 0:
#                         strikes[download_id] = strikes.get(download_id, 0) - 1
...
#                     print("Size:", size)
#                     print("Status:", status)
#                     print("Strike:", strikes.get(download_id, 0))
#                     print("\n")
#                     writer.writerow(
#                         [
#                             title,
